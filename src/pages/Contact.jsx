...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://formspree.io/f/mqawknjn", {
        method: "POST",
        headers: {
  ...
  return (
    <Section>
      <SEO
        title="Contact"
        description="Get in touch with Johnathan Falbo for your next project. Ready to work together on creating amazing digital experiences."
        url="/contact"
      />
      <Container className="max-w-2xl">
        ...
        <div className="mt-12 pt-8 border-t border-white/10 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a
              href="mailto:falbojohnathan@gmail.com"
              className="text-white/80 hover:text-white transition"
            >
              falbojohnathan@gmail.com
            </a>
            <span className="hidden sm:block text-white/30">•</span>
            <a
              href="tel:+1-816-982-4711"
              className="text-white/80 hover:text-white transition"
            >
              (816) 982-4711
            </a>
